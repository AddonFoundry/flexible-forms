    ...
    <div class="no-results md:mt-4 max-w-md mx-auto">
      <div class="card rounded-xl text-center p-6 lg:py-10">
          ...
          <svg width="125" height="125" viewBox="0 0 125 125" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="62.5" cy="62.5" r="62.5" fill="#322D45"/>
            <path d="M74.1538 94.168C79.8315 88.6148 78.378 70.9956 75.9382 62.0832C86.5538 72.1839 88.7341 88.8205 98 94.168H74.1538Z" fill="white"/>
            <path d="M43.3297 62.9405C40.6044 75.7744 31.7851 89.8552 28 93.3516C28.5678 93.9686 31.1795 94.9558 37.0843 93.9686C42.9891 92.9814 49.3248 83.919 52.9818 72.9901C54.4958 68.4653 54.6851 64.7915 60.3627 48.9265C63.2801 40.7745 68.2472 33.8529 73.9248 31.2074C71.6538 30.7961 64.6778 30.6629 59.2272 34.1181C52.414 38.4373 46.7363 46.8981 43.3297 62.9405Z" fill="white"/>
            <path d="M70.0148 58.8746C57.9287 58.8746 52.1095 67.3439 50.7107 71.5786L51.55 58.8746C59.6074 55.0634 67.2171 57.2866 70.0148 58.8746Z" fill="white"/>
          </svg>
          -->
          <svg width="125" height="125" viewBox="0 0 125 125" fill="none" xmlns="http://www.w3.org/2000/svg">
