      ...
      <table data-size="sm" tabindex="0" class="data-table">
        <thead>
          <tr>
            ...
            <th class="actions-column" style="width:54px;"></th>
          </tr>
        </thead>
        <tbody tabindex="0">
            ...
            <td>
              <div>
                <div handle="submissions">
                  {{ form.submissions }} <a :href="'/cp/flexible-forms/' + form.handle + '/submissions'" style="font-size:13px;color:#BBB;position: relative;top:-1px;"></a>
                </div>
              </div>
            </td>
            <th>
