					...
					<small
						...
						<template v-else-if="currentField.config.type == 'textarea'">
							<svg
								...
								<rect
									...
									stroke="#0E2B73"
									stroke-width="2" />
								<rect x="4" y="4" width="10" height="2" fill="#0E2B73" />
								<rect x="4" y="7" width="10" height="2" fill="#0E2B73" />
								<rect x="4" y="10" width="7" height="2" fill="#0E2B73" />
							</svg>
						</template>
						<template v-else-if="currentField.config.type == 'select'">
							<svg
								...
								v-tooltip="currentField.handle">
								<path
									d="M0 1H16C17.1046 1 18 1.89543 18 3V16C18 17.1046 17.1046 18 16 18H0"
									stroke="#0E2B73"
									stroke-width="2" />
								<path
									d="M9.07106 12.0208L12.0208 9.07106C12.6508 8.44109 12.2046 7.36395 11.3137 7.36395H5.41421C4.52331 7.36395 4.07714 8.44109 4.70711 9.07106L7.65684 12.0208C8.04737 12.4113 8.68053 12.4113 9.07106 12.0208Z"
									fill="#0E2B73" />
							</svg>
						</template>
						<template v-else-if="currentField.config.type == 'checkboxes'">
							<svg
								...
								<path
									fill-rule="evenodd"
									clip-rule="evenodd"
									d="M13.928 5.36935L7.59309 12.1129L4 8.59968L5.39824 7.16967L7.53242 9.25642L12.4703 4L13.928 5.36935Z"
									fill="#F1F1F1" />
							</svg>
						</template>
						<template v-else-if="currentField.config.type == 'radio'">
							<svg
								...
								<rect
									...
									stroke="#0E2B73"
									stroke-width="2" />
								<rect x="4" y="4" width="9" height="9" rx="4.5" fill="#0E2B73" />
							</svg>
						</template>
						<template v-else-if="currentField.config.type == 'toggle'">
							<svg
								...
								fill="none"
								xmlns="http://www.w3.org/2000/svg">
								<rect width="16" height="8.8" rx="4.4" fill="#0E2B73" />
								<rect
									x="8"
									y="0.799988"
									width="7.2"
						...
						<template v-else-if="currentField.config.type == 'assets'">
							<svg
								...
								<path
									fill-rule="evenodd"
									clip-rule="evenodd"
									d="M16 2H2L2 15H16V2ZM2 0C0.895431 0 0 0.89543 0 2V15C0 16.1046 0.89543 17 2 17H16C17.1046 17 18 16.1046 18 15V2C18 0.895431 17.1046 0 16 0H2Z"
									fill="#0E2B73" />
								<path
									fill-rule="evenodd"
									clip-rule="evenodd"
									d="M12.2171 5.71655L17.3976 14.4462L15.6776 15.4669L12.2007 9.60781L7.83258 16.8287L4.79721 12.2231L2.24808 15.5632L0.658203 14.3498L4.91669 8.77002L7.76014 13.0844L12.2171 5.71655Z"
									fill="#0E2B73" />
								<path
									fill-rule="evenodd"
									clip-rule="evenodd"
									d="M6.25781 6.66217C7.05442 6.66217 7.7002 6.01639 7.7002 5.21979C7.7002 4.42318 7.05442 3.7774 6.25781 3.7774C5.46121 3.7774 4.81543 4.42318 4.81543 5.21979C4.81543 6.01639 5.46121 6.66217 6.25781 6.66217ZM6.25781 7.66217C7.6067 7.66217 8.7002 6.56868 8.7002 5.21979C8.7002 3.8709 7.6067 2.7774 6.25781 2.7774C4.90892 2.7774 3.81543 3.8709 3.81543 5.21979C3.81543 6.56868 4.90892 7.66217 6.25781 7.66217Z"
									fill="#0E2B73" />
							</svg>
						</template>
