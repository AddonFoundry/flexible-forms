<template>
  ...
  >
    <div class="flexible-forms" slot-scope="{ setFieldValue, setFieldMeta }">
      <header class="mb-6">
      ...
      <section class="card nav-card inline-flex mt-5 mb-4 p-0 rounded-md px-1">
